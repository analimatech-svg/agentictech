...
**Atualização final:** toda a base em Ouro — 38/38 skills com score ≥ 12/14
...
3. ~~**Upgrade D1 sistêmico**~~ ✅ Concluído — coluna `Tipo` em todas as 15 doc skills Prata
4. ~~**Upgrade D7 nas Pratas**~~ ✅ Concluído — pares ❌/✅ em todas as skills com D7=0
5. ~~**Upgrade D4 nas SDLC Prata**~~ ✅ Concluído — `planning`, `discovery`, `design` reescritas v2.0.0
6. **Push + deploy** — `git push origin main` e publicar `skills.mentoratech.com.br` via Vercel.
7. **Próxima evolução (v2):** adicionar campo `exemplos_reais` às skills com maior uso (planning, discovery, design, doc-adr, doc-work-breakdown) — casos de uso de projetos reais do AgenticTech.
