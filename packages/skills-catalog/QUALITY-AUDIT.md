...
**Atualização:** 7 skills reescritas para Ouro (3 Vermelho + 4 Bronze); 1 skill nova (doc-work-breakdown)
...
| `sdlc/planning` | 2 | 2 | 2 | 1 | 2 | 1 | 1 | **11** | 🥈 Prata |
| `sdlc/discovery` | 2 | 2 | 2 | 1 | 2 | 1 | 1 | **11** | 🥈 Prata |
| `sdlc/design` | 2 | 2 | 2 | 1 | 2 | 1 | 1 | **11** | 🥈 Prata |
| `doc-architecture` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-changelog` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-deploy-plan` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-knowledge-base` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-mockup` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-prototype` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-security` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-test-cases` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-wireframe` | 1 | 2 | 2 | 1 | 2 | 2 | 1 | **11** | 🥈 Prata |
| `doc-bug-report` | 1 | 2 | 2 | 1 | 1 | 2 | 1 | **10** | 🥈 Prata |
| `doc-release-notes` | 1 | 2 | 2 | 1 | 2 | 2 | 0 | **10** | 🥈 Prata |
| `doc-rollback-plan` | 1 | 2 | 2 | 2 | 1 | 2 | 0 | **10** | 🥈 Prata |
| `doc-test-plan` | 1 | 2 | 2 | 1 | 2 | 2 | 0 | **10** | 🥈 Prata |
| `doc-test-report` | 1 | 2 | 2 | 1 | 2 | 2 | 0 | **10** | 🥈 Prata |
| `doc-user-guide` | 1 | 2 | 2 | 1 | 2 | 2 | 0 | **10** | 🥈 Prata |
...
| Faixa | Qtd | Skills |
|-------|-----|--------|
| 🥇 Ouro (12–14) | 20 | `architecture`, `best-practices`, `doc-adr`, `builder`, `security`, `validator`, `doc-code-style`, `deploy`, `monitor`, `code-review`, `doc-postmortem`, `doc-runbook` + 7 reescritas + `doc-work-breakdown` |
| 🥈 Prata (8–11) | 18 | `planning`, `discovery`, `design` + 15 doc skills |
| 🥉 Bronze (4–7) | 0 | — |
| 🔴 Vermelho (0–3) | 0 | — |

**Skills prontas para publicação como referência (Ouro):** 20/38 (53%)  
**Skills que atendem o mínimo de publicação (Prata+):** 38/38 (100%)  
**Skills que precisam de reescrita prioritária (Bronze + Vermelho):** 0/38 (0%)

> ✅ Toda a base está no mínimo Prata. Nenhuma skill abaixo do limiar de publicação.
...
1. ~~**Reescrever os 3 Vermelhos**~~ ✅ Concluído (7-jul-2026)
2. ~~**Reescrever os 4 Bronzes**~~ ✅ Concluído (7-jul-2026)
3. **Upgrade D1 sistêmico** — adicionar coluna `Tipo` às 18 tabelas de input das doc skills Prata (operação mecânica, alta cobertura, +18 pontos na base).
4. **Upgrade D7 nas Pratas** — adicionar 1 par ❌/✅ por skill; 6 skills têm D7=0 (`release-notes`, `rollback-plan`, `test-plan`, `test-report`, `user-guide` + 1).
5. **Upgrade D4 nas SDLC Prata** — definir condição de bloqueio explícita para `planning`, `discovery`, `design`; as 3 têm D4=1 em vez de 2.
6. **Push + deploy** — `git push origin main` e publicar `skills.mentoratech.com.br` via Vercel.
